...
const navGroups: { title: string; items: NavItem[] }[] = [
  ...
  },
  {
    title: 'Content',
    items: [
      { to: '/automation', label: 'Sync', icon: <IconSync /> },
      { to: '/content/library', label: 'Content Library', icon: <IconImport /> },
      { to: '/movies', label: 'Movies', icon: <IconFilm /> },
      { to: '/series', label: 'Web Series', icon: <IconTv /> },
      { to: '/anime', label: 'Anime', icon: <IconTv /> },
      { to: '/sync', label: 'Sync Settings', icon: <IconSync /> },
